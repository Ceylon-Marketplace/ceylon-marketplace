...
export function ListingsClient({ initialData, initialCategories }: Props) {
  ...
  const isDefaultState =
    !keyword && page === 1 && JSON.stringify(filters) === JSON.stringify(DEFAULT_FILTERS);
    ...
    <div>
      ...
      {showFilters && (
        <div className="mb-6 grid gap-3 rounded-xl border border-gray-200 bg-gray-50 p-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-gray-600">Listing Type</label>
            <select
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-gray-600">Min Price (LKR)</label>
            <input
              type="number"
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-gray-600">Max Price (LKR)</label>
            <input
              type="number"
